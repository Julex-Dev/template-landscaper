export function Quote({ phone, phoneHref, email, services, copy }) {
      ...
      <div class="site-container" style="position:relative;z-index:1;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:start;">
          ...
          <div class="reveal-left">
            <span class="section-eyebrow" style="color:rgba(106,171,132,0.8);">${copy.quote.eyebrow}</span>
            ...
            <div style="display:flex;flex-direction:column;gap:20px;">
              ${copy.quote.bullets.map(([title, desc]) => `
            ...
            <div style="margin-top:40px;padding:24px;border:1px solid rgba(106,171,132,0.15);border-radius:6px;background:rgba(74,138,100,0.06);">
              <p style="font-size:13px;font-weight:500;letter-spacing:0.06em;text-transform:uppercase;color:var(--color-forest-400);margin-bottom:6px;">${copy.quote.contactLabel}</p>
          ...
          <div class="reveal-right">
            <form id="quote-form" style="display:flex;flex-direction:column;gap:20px;" novalidate>
              ...
              <div>
                ...
                <input type="text" name="address" class="form-input" placeholder="${copy.quote.addressPlaceholder}">
              </div>
              <div>
